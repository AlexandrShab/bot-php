            ...
            {    // Если сообщение - команда боту
             ...
             /* if (msg.text == ('/getchat'+botName) || msg.text == '/getchat'){ // Получение данных о чате
              ...
              { 
                ...
                $hi = goodTime();
                $telega->sendMes($chat_id, $hi . ", " . $user->first_name);
                ...
                $keyboard = writeToExpertKeyboard();
                $telega->sendInlineKeyboard($chat_id, $textAbout, $keyboard);
                $telega->sendMes($chat_id, "Команда ПОМОГИТЕ");
                return;
              }
              return;
